  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <nav className="sticky top-0 z-40 border-b border-slate-100 bg-white/70 backdrop-blur-xl">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3.5">
          <Link href="/" className="flex items-center gap-2">
            <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#005454]">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              href="/register"
              className="rounded-xl bg-[#087f79] px-4 py-2 text-sm font-medium text-white shadow-sm transition hover:shadow-md"
            >
              Get started
            </Link>
          </div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute left-1/2 top-0 -z-10 h-[500px] w-[800px] -translate-x-1/2 rounded-full bg-[#dff1ed] blur-3xl" />

        <div className="mx-auto max-w-6xl px-4 py-24 sm:py-32">
          <div className="mx-auto max-w-3xl text-center">
            <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-teal-100 bg-teal-50/50 px-4 py-1.5 text-sm font-medium text-teal-700">
            ...
            <h1 className="text-5xl font-bold tracking-tight text-slate-900 sm:text-6xl">
              Search smarter.
              <br />
              <span className="text-[#087f79]">
                Move with clarity.
              </span>
            </h1>
            <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-slate-600">
              CareerPilot AI turns scattered job-search activity into one intelligent career workspace.
              Find high-fit opportunities, track every application through
              interviews, and use AI to make each next move stronger.
            </p>
            <div className="mt-10 flex items-center justify-center gap-3">
              <Link
                href="/register"
                className="inline-flex items-center gap-2 rounded-xl bg-[#087f79] px-6 py-3 text-sm font-semibold text-white shadow-md transition hover:bg-[#066e69] hover:shadow-lg"
              >
                Start free
          ...
          <div className="mt-14 grid gap-8 sm:grid-cols-3">
            {[
              ...
              <div key={item.step} className="relative">
                <div className="text-6xl font-bold text-teal-100">{item.step}</div>
            ...
            {[
              ...
              >
                ...
                <div className="mt-5 flex items-center gap-3">
                  <div className="flex h-9 w-9 items-center justify-center rounded-full bg-[#087f79] text-xs font-semibold text-white">
                    {t.initials}
                  </div>
                  <div>
      ...
      <section className="py-24">
        <div className="mx-auto max-w-4xl px-4">
          <div className="relative overflow-hidden rounded-3xl bg-[#005454] px-8 py-16 text-center shadow-xl">
            ...
            <div className="relative z-10">
              ...
              <div className="mt-8 flex items-center justify-center gap-3">
                <Link
                  href="/register"
                  className="inline-flex items-center gap-2 rounded-xl bg-white px-6 py-3 text-sm font-semibold text-teal-700 shadow-md transition hover:shadow-lg hover:bg-teal-50"
                >
                  Create your account
                  <ArrowRight className="h-4 w-4" />
                </Link>
              ...
              <div className="mt-6 flex items-center justify-center gap-6 text-xs text-teal-200">
      ...
      <footer className="border-t border-slate-100 py-10">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row">
          <div className="flex items-center gap-2">
            <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-[#005454]">
